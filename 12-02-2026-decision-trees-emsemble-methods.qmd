...
I estimate the variance of mean, it should be 100/100 ($\frac{\sigma^2}{n}$)
...
I estimate the distribution of variance of mean, it should be *centered* around 100/100 ($\frac{\sigma^2}{n}$)
